	...
	static std::vector<TRaceData> m_vecRaceData =
			{
					...
					{RACE_WOLFMAN_M, "msm/wolfman_m.msm", "d:/ymir work/pc3/wolfman/intro/"},
#endif
			};
	...
	std::vector<TEffect> m_vecEffectData =
			{
					...
					/*
						Bug if you define this when you kill an mob an artefact will remain
...
#ifdef ENABLE_WOLFMAN_CHARACTER
					{pkBase.EFFECT_REFINED + 23, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7_w.mse"},
					{pkBase.EFFECT_REFINED + 24, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_8_w.mse"},
					{pkBase.EFFECT_REFINED + 25, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_w.mse"},

					{pkBase.EFFECT_REFINED + 26, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7_w.mse"},
					{pkBase.EFFECT_REFINED + 27, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_8_w.mse"},
					{pkBase.EFFECT_REFINED + 28, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_w.mse"},
#endif
...
#ifdef ENABLE_WOLFMAN_CHARACTER
const bool CPlayerSettingsModule::LoadNewGeneralMotion(const char *stFolder)
{
	CRaceManager &pkManager = CRaceManager::Instance();
...
#ifdef ENABLE_WOLFMAN_CHARACTER
bool CPlayerSettingsModule::LoadGameWolfman(DWORD dwRace, const char *stFolder)
{
	CRaceManager &pkManager = CRaceManager::Instance();
	pkManager.SelectRace(dwRace);
